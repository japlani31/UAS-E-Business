# -*- coding: utf-8 -*-
"""
UAS E-Business Daring - Universitas Muhammadiyah Metro
Ardiansyah Japlani, S.E., M.B.A. - FEB UM Metro.

Aplikasi fokus tunggal: Ujian Akhir Semester E-Business dengan pengaman anti-contek,
...
st.set_page_config(page_title="UAS E-Business - UM Metro",
...
def buat_kartu_hasil(nama, npm, nilai, benar, total, waktu_str):
    ...
    d.text((24, 20), "BUKTI PENGERJAAN UAS E-BUSINESS", font=font(20, True), fill="white")
